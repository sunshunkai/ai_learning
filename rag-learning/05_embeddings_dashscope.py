# -*- coding: utf-8 -*-
"""05 DashScope Embedding：阿里云 embedding API。"""
...
def main():
    try:
        embedding = build_embedding("dashscope")
    except RuntimeError as exc:
        print(exc)
        print("请先安装: pip install langchain-community dashscope")
        print("并设置: DASHSCOPE_API_KEY")
        return
